        ...
        <header className="header">
            ...
            <nav className='user-nav'>
                <a
                    ...
                    <FontAwesomeIcon
                        icon={faLinkedin}
                        className='user-nav__icon user-nav__icon--linkdin' />
                </a>
                <a
                    ...
                    <FontAwesomeIcon
                        ...
                        className='user-nav__icon user-nav__icon--facebook' />
                </a>
                <a
                    href="http://www.github.com/SharonZissu"
                    className='user-nav__link'>
                    <FontAwesomeIcon
                        icon={faGithubSquare}
                        className='user-nav__icon user-nav__icon--github' />
                </a>
            </nav>
        </header>
    )
